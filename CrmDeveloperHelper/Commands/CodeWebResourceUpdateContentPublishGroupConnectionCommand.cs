...
{
    internal sealed class CodeWebResourceUpdateContentPublishGroupConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeWebResourceUpdateContentPublishGroupConnectionCommandId;

        private CodeWebResourceUpdateContentPublishGroupConnectionCommand(Package package)
        {
        ...
        {
            Instance = new CodeWebResourceUpdateContentPublishGroupConnectionCommand(package);
        }
