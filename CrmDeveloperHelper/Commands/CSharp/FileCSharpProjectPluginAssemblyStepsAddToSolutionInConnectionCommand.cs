...
{
    internal sealed class FileCSharpProjectPluginAssemblyStepsAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileCSharpProjectPluginAssemblyStepsAddToSolutionInConnectionCommandId;

        private FileCSharpProjectPluginAssemblyStepsAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new FileCSharpProjectPluginAssemblyStepsAddToSolutionInConnectionCommand(package);
        }
