...
{
    internal sealed class FolderCSharpProjectPluginAssemblyStepsAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderCSharpProjectPluginAssemblyStepsAddToSolutionInConnectionCommandId;

        private FolderCSharpProjectPluginAssemblyStepsAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new FolderCSharpProjectPluginAssemblyStepsAddToSolutionInConnectionCommand(package);
        }
