...
{
    internal sealed class DocumentsCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsCSharpProjectPluginAssemblyStepsAddToSolutionLastCommandId;

        private DocumentsCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new DocumentsCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand(package);
        }
