...
{
    internal sealed class CodeCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeCSharpProjectPluginAssemblyStepsAddToSolutionLastCommandId;

        private CodeCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new CodeCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand(package);
        }
