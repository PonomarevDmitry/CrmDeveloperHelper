...
{
    internal sealed class FileCSharpUpdateEntityMetadataFileProxyClassCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileCSharpUpdateEntityMetadataFileProxyClassCommandId;

        private FileCSharpUpdateEntityMetadataFileProxyClassCommand(Package package)
        {
        ...
        {
            Instance = new FileCSharpUpdateEntityMetadataFileProxyClassCommand(package);
        }
