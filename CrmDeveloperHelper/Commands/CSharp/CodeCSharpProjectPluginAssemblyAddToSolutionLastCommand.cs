...
{
    internal sealed class CodeCSharpProjectPluginAssemblyAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeCSharpProjectPluginAssemblyAddToSolutionLastCommandId;

        private CodeCSharpProjectPluginAssemblyAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new CodeCSharpProjectPluginAssemblyAddToSolutionLastCommand(package);
        }
