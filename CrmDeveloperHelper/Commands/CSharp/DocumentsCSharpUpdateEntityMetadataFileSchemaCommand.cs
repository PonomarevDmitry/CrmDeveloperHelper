...
{
    internal sealed class DocumentsCSharpUpdateEntityMetadataFileSchemaCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsCSharpUpdateEntityMetadataFileSchemaCommandId;

        private DocumentsCSharpUpdateEntityMetadataFileSchemaCommand(Package package)
        {
        ...
        {
            Instance = new DocumentsCSharpUpdateEntityMetadataFileSchemaCommand(package);
        }
