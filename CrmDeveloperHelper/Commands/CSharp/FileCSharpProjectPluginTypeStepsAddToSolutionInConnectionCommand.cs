...
{
    internal sealed class FileCSharpProjectPluginTypeStepsAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileCSharpProjectPluginTypeStepsAddToSolutionInConnectionCommandId;

        private FileCSharpProjectPluginTypeStepsAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new FileCSharpProjectPluginTypeStepsAddToSolutionInConnectionCommand(package);
        }
