...
{
    internal sealed class FileCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileCSharpProjectPluginAssemblyStepsAddToSolutionLastCommandId;

        private FileCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new FileCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand(package);
        }
