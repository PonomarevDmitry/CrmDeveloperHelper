...
{
    internal sealed class DocumentsReportAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsReportAddToSolutionInConnectionCommandId;

        private DocumentsReportAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new DocumentsReportAddToSolutionInConnectionCommand(package);
        }
