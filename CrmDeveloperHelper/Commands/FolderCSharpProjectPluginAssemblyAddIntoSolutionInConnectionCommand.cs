...
{
    internal sealed class FolderCSharpProjectPluginAssemblyAddIntoSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderCSharpProjectPluginAssemblyAddIntoSolutionInConnectionCommandId;

        private FolderCSharpProjectPluginAssemblyAddIntoSolutionInConnectionCommand(Package package)
        {
        ...
        public static FolderCSharpProjectPluginAssemblyAddIntoSolutionInConnectionCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new FolderCSharpProjectPluginAssemblyAddIntoSolutionInConnectionCommand(package);
        }
