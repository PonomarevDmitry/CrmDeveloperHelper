...
{
    internal sealed class FileWebResourceAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileWebResourceAddToSolutionInConnectionCommandId;

        private FileWebResourceAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new FileWebResourceAddToSolutionInConnectionCommand(package);
        }
