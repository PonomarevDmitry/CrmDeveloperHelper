...
{
    internal sealed class CodeWebResourceAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeWebResourceAddToSolutionInConnectionCommandId;

        private CodeWebResourceAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new CodeWebResourceAddToSolutionInConnectionCommand(package);
        }
