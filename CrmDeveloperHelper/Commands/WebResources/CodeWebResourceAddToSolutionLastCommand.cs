...
{
    internal sealed class CodeWebResourceAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeWebResourceAddToSolutionLastCommandId;

        private CodeWebResourceAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new CodeWebResourceAddToSolutionLastCommand(package);
        }
