...
{
    internal sealed class FolderWebResourceAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderWebResourceAddToSolutionInConnectionCommandId;

        private FolderWebResourceAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new FolderWebResourceAddToSolutionInConnectionCommand(package);
        }
