...
{
    internal sealed class FileWebResourceUpdateContentPublishEqualByTextCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileWebResourceUpdateContentPublishEqualByTextCommandId;
