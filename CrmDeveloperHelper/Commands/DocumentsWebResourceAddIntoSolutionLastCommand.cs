...
{
    internal sealed class DocumentsWebResourceAddIntoSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsWebResourceAddIntoSolutionLastCommandId;

        private DocumentsWebResourceAddIntoSolutionLastCommand(Package package)
        {
        ...
        public static DocumentsWebResourceAddIntoSolutionLastCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new DocumentsWebResourceAddIntoSolutionLastCommand(package);
        }
        ...
        private void menuItem_BeforeQueryStatus(object sender, EventArgs e)
        {
            try
            {
                if (sender is OleMenuCommand menuCommand)
                {
                    ...
                    var visible = CommonHandlers.CheckOpenedDocumentsExtension(applicationObject, FileOperations.SupportsWebResourceType);
