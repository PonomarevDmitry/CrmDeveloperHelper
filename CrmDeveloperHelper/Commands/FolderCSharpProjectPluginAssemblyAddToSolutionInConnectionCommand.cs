...
{
    internal sealed class FolderCSharpProjectPluginAssemblyAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderCSharpProjectPluginAssemblyAddToSolutionInConnectionCommandId;

        private FolderCSharpProjectPluginAssemblyAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new FolderCSharpProjectPluginAssemblyAddToSolutionInConnectionCommand(package);
        }
