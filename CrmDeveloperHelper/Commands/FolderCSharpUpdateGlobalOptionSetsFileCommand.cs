...
{
    internal sealed class FolderCSharpUpdateGlobalOptionSetsFileCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderCSharpUpdateGlobalOptionSetsFileCommandId;
