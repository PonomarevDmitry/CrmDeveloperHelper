...
{
    internal sealed class DocumentsCSharpUpdateEntityMetadataFileProxyClassCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsCSharpUpdateEntityMetadataFileProxyClassCommandId;

        private DocumentsCSharpUpdateEntityMetadataFileProxyClassCommand(Package package)
        {
        ...
        {
            Instance = new DocumentsCSharpUpdateEntityMetadataFileProxyClassCommand(package);
        }
