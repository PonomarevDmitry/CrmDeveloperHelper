...
{
    internal sealed class FileCSharpProjectPluginTypeStepsAddIntoSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileCSharpProjectPluginTypeStepsAddIntoSolutionInConnectionCommandId;

        private FileCSharpProjectPluginTypeStepsAddIntoSolutionInConnectionCommand(Package package)
        {
        ...
        public static FileCSharpProjectPluginTypeStepsAddIntoSolutionInConnectionCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new FileCSharpProjectPluginTypeStepsAddIntoSolutionInConnectionCommand(package);
        }
