...
{
    internal sealed class FolderCSharpProjectPluginTypeStepsAddIToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderCSharpProjectPluginTypeStepsAddToSolutionInConnectionCommandId;

        private FolderCSharpProjectPluginTypeStepsAddIToSolutionInConnectionCommand(Package package)
        {
        ...
        public static FolderCSharpProjectPluginTypeStepsAddIToSolutionInConnectionCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new FolderCSharpProjectPluginTypeStepsAddIToSolutionInConnectionCommand(package);
        }
