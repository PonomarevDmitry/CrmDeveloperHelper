...
{
    internal class DocumentsCSharpProjectPluginTypeStepsAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsCSharpProjectPluginTypeStepsAddToSolutionInConnectionCommandId;

        private DocumentsCSharpProjectPluginTypeStepsAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new DocumentsCSharpProjectPluginTypeStepsAddToSolutionInConnectionCommand(package);
        }
