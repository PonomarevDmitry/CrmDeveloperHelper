...
{
    internal sealed class CommonOpenDefaultSolutionInWebCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CommonOpenDefaultSolutionInWebCommandId;

        private CommonOpenDefaultSolutionInWebCommand(Package package)
        {
        ...
        {
            Instance = new CommonOpenDefaultSolutionInWebCommand(package);
        }
