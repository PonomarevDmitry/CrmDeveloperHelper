...
{
    internal sealed class DocumentsReportAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsReportAddToSolutionLastCommandId;

        private DocumentsReportAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new DocumentsReportAddToSolutionLastCommand(package);
        }
