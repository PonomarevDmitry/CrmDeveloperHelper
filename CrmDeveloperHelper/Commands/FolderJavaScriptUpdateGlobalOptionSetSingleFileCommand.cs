...
{
    internal sealed class FolderJavaScriptUpdateGlobalOptionSetSingleFileCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderJavaScriptUpdateGlobalOptionSetSingleFileCommandId;

        private FolderJavaScriptUpdateGlobalOptionSetSingleFileCommand(Package package)
        {
        ...
        {
            Instance = new FolderJavaScriptUpdateGlobalOptionSetSingleFileCommand(package);
        }
