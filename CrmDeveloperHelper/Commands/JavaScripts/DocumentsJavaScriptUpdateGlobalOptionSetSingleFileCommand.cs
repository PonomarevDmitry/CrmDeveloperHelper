...
{
    internal sealed class DocumentsJavaScriptUpdateGlobalOptionSetSingleFileCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsJavaScriptUpdateGlobalOptionSetSingleFileCommandId;

        private DocumentsJavaScriptUpdateGlobalOptionSetSingleFileCommand(Package package)
        {
        ...
        {
            Instance = new DocumentsJavaScriptUpdateGlobalOptionSetSingleFileCommand(package);
        }
