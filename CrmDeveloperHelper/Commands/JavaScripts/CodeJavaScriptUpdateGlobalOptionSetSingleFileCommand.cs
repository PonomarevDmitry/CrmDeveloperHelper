...
{
    internal sealed class CodeJavaScriptUpdateGlobalOptionSetSingleFileCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeJavaScriptUpdateGlobalOptionSetSingleFileCommandId;

        private CodeJavaScriptUpdateGlobalOptionSetSingleFileCommand(Package package)
        {
        ...
        {
            Instance = new CodeJavaScriptUpdateGlobalOptionSetSingleFileCommand(package);
        }
