...
{
    internal sealed class CodeJavaScriptUpdateGlobalOptionSetAllFileCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeJavaScriptUpdateGlobalOptionSetAllFileCommandId;

        private CodeJavaScriptUpdateGlobalOptionSetAllFileCommand(Package package)
        {
        ...
        {
            Instance = new CodeJavaScriptUpdateGlobalOptionSetAllFileCommand(package);
        }
