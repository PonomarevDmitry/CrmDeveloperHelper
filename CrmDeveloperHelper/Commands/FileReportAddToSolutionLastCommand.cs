...
{
    internal sealed class FileReportAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileReportAddToSolutionLastCommandId;

        private FileReportAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new FileReportAddToSolutionLastCommand(package);
        }
