...
{
    internal sealed class FolderAddGlobalOptionSetFileInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderAddGlobalOptionSetFileInConnectionCommandId;

        private FolderAddGlobalOptionSetFileInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new FolderAddGlobalOptionSetFileInConnectionCommand(package);
        }
