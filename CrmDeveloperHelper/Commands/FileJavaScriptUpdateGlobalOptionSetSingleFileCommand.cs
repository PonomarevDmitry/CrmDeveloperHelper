...
{
    internal sealed class FileJavaScriptUpdateGlobalOptionSetSingleFileCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileJavaScriptUpdateGlobalOptionSetSingleFileCommandId;

        private FileJavaScriptUpdateGlobalOptionSetSingleFileCommand(Package package)
        {
        ...
        {
            Instance = new FileJavaScriptUpdateGlobalOptionSetSingleFileCommand(package);
        }
