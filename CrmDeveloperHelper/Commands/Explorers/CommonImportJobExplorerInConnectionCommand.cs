...
{
    internal sealed class CommonImportJobExplorerInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CommonImportJobExplorerInConnectionCommandId;

        private CommonImportJobExplorerInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new CommonImportJobExplorerInConnectionCommand(package);
        }
