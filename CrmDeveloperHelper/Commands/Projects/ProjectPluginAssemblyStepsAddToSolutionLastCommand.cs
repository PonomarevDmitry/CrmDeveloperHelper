...
{
    internal sealed class ProjectPluginAssemblyStepsAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.ProjectPluginAssemblyStepsAddToSolutionLastCommandId;

        private ProjectPluginAssemblyStepsAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new ProjectPluginAssemblyStepsAddToSolutionLastCommand(package);
        }
