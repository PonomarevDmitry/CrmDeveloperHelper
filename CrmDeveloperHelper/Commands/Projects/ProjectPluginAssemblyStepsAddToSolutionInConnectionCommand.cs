...
{
    internal sealed class ProjectPluginAssemblyStepsAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.ProjectPluginAssemblyStepsAddToSolutionInConnectionCommandId;

        private ProjectPluginAssemblyStepsAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new ProjectPluginAssemblyStepsAddToSolutionInConnectionCommand(package);
        }
