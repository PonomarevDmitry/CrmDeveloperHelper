...
{
    internal sealed class DocumentsWebResourceAddIntoSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsWebResourceAddIntoSolutionInConnectionCommandId;

        private DocumentsWebResourceAddIntoSolutionInConnectionCommand(Package package)
        {
        ...
        public static DocumentsWebResourceAddIntoSolutionInConnectionCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new DocumentsWebResourceAddIntoSolutionInConnectionCommand(package);
        }
