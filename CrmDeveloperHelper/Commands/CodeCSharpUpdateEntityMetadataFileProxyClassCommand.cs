...
{
    internal sealed class CodeCSharpUpdateEntityMetadataFileProxyClassCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeCSharpUpdateEntityMetadataFileProxyClassCommandId;

        private CodeCSharpUpdateEntityMetadataFileProxyClassCommand(Package package)
        {
        ...
        {
            Instance = new CodeCSharpUpdateEntityMetadataFileProxyClassCommand(package);
        }
