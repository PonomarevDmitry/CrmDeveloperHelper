...
{
    internal sealed class FileWebResourceAddIntoSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileWebResourceAddIntoSolutionInConnectionCommandId;

        private FileWebResourceAddIntoSolutionInConnectionCommand(Package package)
        {
        ...
        public static FileWebResourceAddIntoSolutionInConnectionCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new FileWebResourceAddIntoSolutionInConnectionCommand(package);
        }
