...
{
    internal sealed class CodeCSharpProjectPluginAssemblyStepsAddIntoSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeCSharpProjectPluginAssemblyStepsAddIntoSolutionInConnectionCommandId;

        private CodeCSharpProjectPluginAssemblyStepsAddIntoSolutionInConnectionCommand(Package package)
        {
        ...
        public static CodeCSharpProjectPluginAssemblyStepsAddIntoSolutionInConnectionCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new CodeCSharpProjectPluginAssemblyStepsAddIntoSolutionInConnectionCommand(package);
        }
