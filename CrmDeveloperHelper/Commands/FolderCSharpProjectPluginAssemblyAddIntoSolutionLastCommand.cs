...
{
    internal sealed class FolderCSharpProjectPluginAssemblyAddIntoSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderCSharpProjectPluginAssemblyAddIntoSolutionLastCommandId;

        private FolderCSharpProjectPluginAssemblyAddIntoSolutionLastCommand(Package package)
        {
        ...
        public static FolderCSharpProjectPluginAssemblyAddIntoSolutionLastCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new FolderCSharpProjectPluginAssemblyAddIntoSolutionLastCommand(package);
        }
