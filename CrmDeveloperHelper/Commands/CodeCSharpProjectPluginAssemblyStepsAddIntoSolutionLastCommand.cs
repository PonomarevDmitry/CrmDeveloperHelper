...
{
    internal sealed class CodeCSharpProjectPluginAssemblyStepsAddIntoSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeCSharpProjectPluginAssemblyStepsAddIntoSolutionLastCommandId;

        private CodeCSharpProjectPluginAssemblyStepsAddIntoSolutionLastCommand(Package package)
        {
        ...
        public static CodeCSharpProjectPluginAssemblyStepsAddIntoSolutionLastCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new CodeCSharpProjectPluginAssemblyStepsAddIntoSolutionLastCommand(package);
        }
