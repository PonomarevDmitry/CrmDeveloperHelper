...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Commands.Xmls
{
    internal sealed class CodeXmlSystemFormGetCurrentCommand : AbstractCommand
    {
        ...
        public static CodeXmlSystemFormGetCurrentCommand Instance { get; private set; }

        public static void Initialize(OleMenuCommandService commandService)
        {
            Instance = new CodeXmlSystemFormGetCurrentCommand(commandService);
        }
        ...
        protected override void CommandAction(DTEHelper helper)
        {
            ...
            {
                helper.HandleSystemFormGetCurrentCommand(null, selectedFiles.FirstOrDefault());
            }
        }
