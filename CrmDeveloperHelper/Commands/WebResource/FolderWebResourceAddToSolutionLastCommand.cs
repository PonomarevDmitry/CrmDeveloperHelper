...
{
    internal sealed class FolderWebResourceAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderWebResourceAddToSolutionLastCommandId;

        private FolderWebResourceAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new FolderWebResourceAddToSolutionLastCommand(package);
        }
