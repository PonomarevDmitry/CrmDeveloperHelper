...
{
    internal sealed class DocumentsWebResourceAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsWebResourceAddToSolutionInConnectionCommandId;

        private DocumentsWebResourceAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new DocumentsWebResourceAddToSolutionInConnectionCommand(package);
        }
