...
{
    internal sealed class FileWebResourceAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileWebResourceAddToSolutionLastCommandId;

        private FileWebResourceAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new FileWebResourceAddToSolutionLastCommand(package);
        }
