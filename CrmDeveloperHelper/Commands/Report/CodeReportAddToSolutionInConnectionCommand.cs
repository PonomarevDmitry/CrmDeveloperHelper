...
{
    internal sealed class CodeReportAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeReportAddToSolutionInConnectionCommandId;

        private CodeReportAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new CodeReportAddToSolutionInConnectionCommand(package);
        }
