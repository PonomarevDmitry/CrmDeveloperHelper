...
{
    internal sealed class FolderWebResourceAddIntoSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderWebResourceAddIntoSolutionInConnectionCommandId;

        private FolderWebResourceAddIntoSolutionInConnectionCommand(Package package)
        {
        ...
        public static FolderWebResourceAddIntoSolutionInConnectionCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new FolderWebResourceAddIntoSolutionInConnectionCommand(package);
        }
