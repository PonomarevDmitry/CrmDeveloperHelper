...
{
    internal sealed class FolderCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderCSharpProjectPluginAssemblyStepsAddToSolutionLastCommandId;

        private FolderCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new FolderCSharpProjectPluginAssemblyStepsAddToSolutionLastCommand(package);
        }
