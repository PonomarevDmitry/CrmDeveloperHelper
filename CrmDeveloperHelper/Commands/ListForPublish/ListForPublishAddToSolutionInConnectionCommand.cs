...
{
    internal sealed class ListForPublishAddToSolutionInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.ListForPublishAddToSolutionInConnectionCommandId;

        private ListForPublishAddToSolutionInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new ListForPublishAddToSolutionInConnectionCommand(package);
        }
