...
{
    internal sealed class ProjectRegisterPluginAssemblyInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.ProjectRegisterPluginAssemblyInConnectionCommandId;

        private ProjectRegisterPluginAssemblyInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new ProjectRegisterPluginAssemblyInConnectionCommand(package);
        }
