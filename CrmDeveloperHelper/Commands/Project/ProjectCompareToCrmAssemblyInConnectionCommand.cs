...
{
    internal sealed class ProjectCompareToCrmAssemblyInConnectionCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.ProjectCompareToCrmAssemblyInConnectionCommandId;

        private ProjectCompareToCrmAssemblyInConnectionCommand(Package package)
        {
        ...
        {
            Instance = new ProjectCompareToCrmAssemblyInConnectionCommand(package);
        }
