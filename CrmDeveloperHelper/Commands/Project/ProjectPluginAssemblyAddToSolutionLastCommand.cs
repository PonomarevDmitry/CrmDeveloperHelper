...
{
    internal sealed class ProjectPluginAssemblyAddToSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.ProjectPluginAssemblyAddToSolutionLastCommandId;

        private ProjectPluginAssemblyAddToSolutionLastCommand(Package package)
        {
        ...
        {
            Instance = new ProjectPluginAssemblyAddToSolutionLastCommand(package);
        }
