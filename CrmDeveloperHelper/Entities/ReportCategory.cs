...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Entities
{
    ...
    public partial class ReportCategory : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ReportCategory.Schema.OptionSets.categorycode> CategoryCodeEnum
        {
            ...
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ReportCategory.Schema.Attributes.categorycode);
                if (((optionSet != null) 
                            && System.Enum.IsDefined(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ReportCategory.Schema.OptionSets.categorycode), optionSet.Value)))
                {
                    return ((Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ReportCategory.Schema.OptionSets.categorycode)(System.Enum.ToObject(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ReportCategory.Schema.OptionSets.categorycode), optionSet.Value)));
                }
                else
                {
                    return null;
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.GlobalOptionSets.componentstate> ComponentStateEnum
        {
            ...
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ReportCategory.Schema.Attributes.componentstate);
                if (((optionSet != null) 
