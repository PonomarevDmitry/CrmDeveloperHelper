...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Entities
{
    ...
    [System.ComponentModel.DescriptionAttribute("Solution Component")]
    public partial class SolutionComponent : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.GlobalOptionSets.componenttype> ComponentTypeEnum
        {
            ...
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSetValue = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SolutionComponent.Schema.Attributes.componenttype);
            ...
            set
            {
                ...
                if ((value == null))
                {
                    this.SetAttributeValue(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SolutionComponent.Schema.Attributes.componenttype, null);
                }
                else
                {
                    this.SetAttributeValue(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SolutionComponent.Schema.Attributes.componenttype, new Microsoft.Xrm.Sdk.OptionSetValue(((int)(value))));
                }
                this.OnPropertyChanged(nameof(ComponentType));
        ...
        [System.ComponentModel.DescriptionAttribute("Root Component Behavior")]
        [System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SolutionComponent.Schema.OptionSets.rootcomponentbehavior> RootComponentBehaviorEnum
        {
            [System.Diagnostics.DebuggerNonUserCodeAttribute()]
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSetValue = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SolutionComponent.Schema.Attributes.rootcomponentbehavior);
                if (((optionSetValue != null) 
                            && System.Enum.IsDefined(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SolutionComponent.Schema.OptionSets.rootcomponentbehavior), optionSetValue.Value)))
                {
                    return ((Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SolutionComponent.Schema.OptionSets.rootcomponentbehavior)(System.Enum.ToObject(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SolutionComponent.Schema.OptionSets.rootcomponentbehavior), optionSetValue.Value)));
                }
                else
                {
                    return null;
            ...
            set
            {
                ...
                if ((value == null))
                {
                    this.SetAttributeValue(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SolutionComponent.Schema.Attributes.rootcomponentbehavior, null);
                }
                else
                {
                    this.SetAttributeValue(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SolutionComponent.Schema.Attributes.rootcomponentbehavior, new Microsoft.Xrm.Sdk.OptionSetValue(((int)(value))));
                }
                this.OnPropertyChanged(nameof(RootComponentBehavior));
