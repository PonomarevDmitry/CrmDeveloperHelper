...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Entities
{
    ...
    public partial class PickListMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.GlobalOptionSets.componentstate> ComponentStateEnum
        {
            ...
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.Attributes.componentstate);
                if (((optionSet != null) 
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.processcode> ProcessCodeEnum
        {
            ...
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.Attributes.processcode);
                if (((optionSet != null) 
                            && System.Enum.IsDefined(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.processcode), optionSet.Value)))
                {
                    return ((Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.processcode)(System.Enum.ToObject(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.processcode), optionSet.Value)));
                }
                else
                {
                    return null;
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.statecode> StateCodeEnum
        {
            ...
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.Attributes.statecode);
                if (((optionSet != null) 
                            && System.Enum.IsDefined(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.statecode), optionSet.Value)))
                {
                    return ((Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.statecode)(System.Enum.ToObject(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.statecode), optionSet.Value)));
                }
                else
                {
                    return null;
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.statuscode> StatusCodeEnum
        {
            ...
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.Attributes.statuscode);
                if (((optionSet != null) 
                            && System.Enum.IsDefined(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.statuscode), optionSet.Value)))
                {
                    return ((Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.statuscode)(System.Enum.ToObject(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.PickListMapping.Schema.OptionSets.statuscode), optionSet.Value)));
                }
                else
                {
                    return null;
