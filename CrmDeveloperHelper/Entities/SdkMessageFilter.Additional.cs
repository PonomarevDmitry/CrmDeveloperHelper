...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Entities
{
    public partial class SdkMessageFilter
    {
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.GlobalOptionSets.AvailabilityEnum> AvailabilityEnum
        {
            ...
            get
            {
                System.Nullable<int> nullableInt = this.GetAttributeValue<System.Nullable<int>>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SdkMessageFilter.Schema.Attributes.availability);
            ...
            set
            {
                ...
                if ((value.HasValue))
                {
                    this.SetAttributeValue(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SdkMessageFilter.Schema.Attributes.availability, ((int)value.Value));
                }
                else
                {
                    this.SetAttributeValue(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.SdkMessageFilter.Schema.Attributes.availability, null);
                }
