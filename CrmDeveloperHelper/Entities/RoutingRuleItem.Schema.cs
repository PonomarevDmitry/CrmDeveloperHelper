...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Entities
{
    public partial class RoutingRuleItem
    {
        ...
        public static partial class Schema
        {
            ...
            public const int EntityObjectTypeCode = 8199;
            ...
            public static partial class Attributes
            {
                ...
                ///<summary>
                /// DisplayName:
                ///     (English - United States - 1033): Assign ObjectId Name
                ///     (Russian - 1049): Назначьте имя ObjectId
                /// 
                /// Description:
                ///     (English - United States - 1033): Provide the user or team that the item will be assigned to
                ///     (Russian - 1049): Укажите пользователя или рабочую группу, которым будет назначен элемент
                /// 
                /// SchemaName: AssignObjectIdName
                /// StringAttributeMetadata    AttributeType: String    AttributeTypeName: StringType    RequiredLevel: None    AttributeOf 'assignobjectid'
                /// IsValidForCreate: True    IsValidForUpdate: True
                ...
                ///<summary>
                /// DisplayName:
                ///     (English - United States - 1033): AssignObject Type
                ///     (Russian - 1049): Тип AssignObject
                /// 
                /// SchemaName: AssignObjectIdType
                /// EntityNameAttributeMetadata    AttributeType: EntityName    AttributeTypeName: EntityNameType    RequiredLevel: None    AttributeOf 'assignobjectid'
                /// IsValidForCreate: True    IsValidForUpdate: True
                /// IsValidForRead: True    IsValidForAdvancedFind: False
                /// IsLogical: False    IsSecured: False    IsCustomAttribute: False    SourceType: Simple
                /// PropertyName                   Value
                ...
                ///<summary>
                /// DisplayName:
                ///     (English - United States - 1033): AssignObjectId Yomi Name
                ///     (Russian - 1049): Фонетическое имя AssignObjectId
                /// 
                /// Description:
                ///     (English - United States - 1033): Assign Object Yomi Name
                ///     (Russian - 1049): Назначьте фонетическое имя объекта
                /// 
                /// SchemaName: AssignObjectIdYomiName
                /// StringAttributeMetadata    AttributeType: String    AttributeTypeName: StringType    RequiredLevel: None    AttributeOf 'assignobjectid'
                /// IsValidForCreate: True    IsValidForUpdate: True
                /// IsValidForRead: True    IsValidForAdvancedFind: False
                /// IsLogical: False    IsSecured: False    IsCustomAttribute: False    SourceType: 0
                ...
                ///<summary>
                /// SchemaName: RoutedQueueIdName
                /// StringAttributeMetadata    AttributeType: String    AttributeTypeName: StringType    RequiredLevel: None    AttributeOf 'routedqueueid'
                /// IsValidForCreate: False    IsValidForUpdate: False
                /// IsValidForRead: True    IsValidForAdvancedFind: False
                /// IsLogical: True    IsSecured: False    IsCustomAttribute: False    SourceType: 0
                /// MaxLength = 400
                ...
                ///<summary>
                /// SchemaName: RoutingRuleIdName
                /// StringAttributeMetadata    AttributeType: String    AttributeTypeName: StringType    RequiredLevel: None    AttributeOf 'routingruleid'
                /// IsValidForCreate: False    IsValidForUpdate: False
                /// IsValidForRead: True    IsValidForAdvancedFind: False
                /// IsLogical: True    IsSecured: False    IsCustomAttribute: False    SourceType: 0
                /// MaxLength = 100
            ...
            public static partial class ManyToOne
            {
                ...
                ///         (Russian - 1049): Пользователь, имеющий доступ к системе Microsoft CRM, которому принадлежат объекты в базе данных Microsoft CRM.
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("N:1 - Relationship lk_RoutingRuleItem_createdby")]
                ...
                ///         (Russian - 1049): Пользователь, имеющий доступ к системе Microsoft CRM, которому принадлежат объекты в базе данных Microsoft CRM.
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("N:1 - Relationship lk_routingruleitem_createdonbehalfby")]
                ...
                ///         (Russian - 1049): Пользователь, имеющий доступ к системе Microsoft CRM, которому принадлежат объекты в базе данных Microsoft CRM.
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("N:1 - Relationship lk_routingruleitem_modifiedby")]
                ...
                ///         (Russian - 1049): Пользователь, имеющий доступ к системе Microsoft CRM, которому принадлежат объекты в базе данных Microsoft CRM.
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("N:1 - Relationship lk_routingruleitem_modifiedonbehalfby")]
                ...
                ///         (Russian - 1049): Верхний уровень бизнес-иерархии Microsoft Dynamics 365. Организация может являться конкретной компанией, холдингом или корпорацией.
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("N:1 - Relationship organization_routingruleitems")]
                ...
                ///         (Russian - 1049): Список записей, требующих действий от пользователя, например, организаций, действий и обращений.
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("N:1 - Relationship queue_routingruleitem")]
                ...
                /// AssociatedMenuConfiguration.Order          null
                /// 
                /// ReferencedEntity routingrule:    PrimaryIdAttribute routingruleid    PrimaryNameAttribute name
                ///     DisplayName:
                ///         (English - United States - 1033): Routing Rule Set
                ///         (Russian - 1049): Набор правил маршрутизации
                ///     
                ...
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("N:1 - Relationship routingrule_entries")]
                ...
                ///         (Russian - 1049): Набор системных пользователей, которые обычно участвуют в совместной работе. Рабочие группы можно использовать для упрощения предоставления участникам группы общего доступа к записям и данным организации, если участники принадлежат к разным бизнес-единицам.
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("N:1 - Relationship team_routingruleitem")]
                ...
                ///         (Russian - 1049): Валюта, в которой выполняется финансовая операция.
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("N:1 - Relationship TransactionCurrency_routingruleitem")]
                ...
                ///         (Russian - 1049): Пользователь, имеющий доступ к системе Microsoft CRM, которому принадлежат объекты в базе данных Microsoft CRM.
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("N:1 - Relationship user_routingruleitem")]
            ...
            public static partial class OneToMany
            {
                ...
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("1:N - Relationship routingruleitem_Annotation")]
                ...
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("1:N - Relationship routingruleitem_AsyncOperations")]
                ...
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("1:N - Relationship routingruleitem_BulkDeleteFailures")]
                ...
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("1:N - Relationship routingruleitem_ProcessSessions")]
                ...
                ///</summary>
                [System.ComponentModel.DescriptionAttribute("1:N - Relationship routingruleitem_userentityinstancedatas")]
