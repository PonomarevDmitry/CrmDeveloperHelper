...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Entities
{
    ...
    public partial class ChannelProperty : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.GlobalOptionSets.componentstate> ComponentStateEnum
        {
            ...
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.Attributes.componentstate);
                if (((optionSet != null) 
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.datatype> DataTypeEnum
        {
            ...
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.Attributes.datatype);
                if (((optionSet != null) 
                            && System.Enum.IsDefined(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.datatype), optionSet.Value)))
                {
                    return ((Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.datatype)(System.Enum.ToObject(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.datatype), optionSet.Value)));
                }
                else
                {
                    return null;
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.statecode> statecodeEnum
        {
            ...
            get
            {
                ...
                if (((optionSet != null) 
                            && System.Enum.IsDefined(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.statecode), optionSet.Value)))
                {
                    return ((Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.statecode)(System.Enum.ToObject(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.statecode), optionSet.Value)));
                }
                else
                {
                    return null;
        ...
        public System.Nullable<Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.statuscode> statuscodeEnum
        {
            ...
            get
            {
                Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.Attributes.statuscode);
                if (((optionSet != null) 
                            && System.Enum.IsDefined(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.statuscode), optionSet.Value)))
                {
                    return ((Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.statuscode)(System.Enum.ToObject(typeof(Nav.Common.VSPackages.CrmDeveloperHelper.Entities.ChannelProperty.Schema.OptionSets.statuscode), optionSet.Value)));
                }
                else
                {
                    return null;
