...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Views
{
    public partial class WindowEntityRelationshipManyToManyExplorer : WindowBase
    {
        ...
        private void ToggleControls(ConnectionData connectionData, bool enabled, string statusFormat, params object[] args)
        {
            ...
            ToggleControl(enabled, this.tSProgressBar, cmBCurrentConnection, mIClearEntityCacheAndRefresh, mIClearEntityRelationshipCacheAndRefresh);
        ...
        private async Task AddEntityRelationshipIntoSolution(bool withSelect, string solutionUniqueName)
        {
            ...
            try
            {
                ...
                await SolutionController.AddSolutionComponentsGroupIntoSolution(_iWriteToOutput, service, null, _commonConfig, solutionUniqueName, ComponentType.EntityRelationship, entityRelationshipList.Select(item => item.ManyToManyRelationshipMetadata.MetadataId.Value).ToList(), null, withSelect);
            }
            catch (Exception ex)
            {
                this._iWriteToOutput.WriteErrorToOutput(service.ConnectionData, ex);
