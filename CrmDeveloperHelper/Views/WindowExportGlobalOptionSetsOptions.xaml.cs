...
{
    public partial class WindowExportGlobalOptionSetsOptions : WindowBase
    {
        private readonly IWriteToOutput _iWriteToOutput;

        private readonly CommonConfiguration _commonConfig;

        public WindowExportGlobalOptionSetsOptions(IWriteToOutput iWriteToOutput, CommonConfiguration commonConfig, ConnectionData connectionData)
        {
            InitializeComponent();
