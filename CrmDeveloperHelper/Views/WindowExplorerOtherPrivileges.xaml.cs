...
{
    public partial class WindowExplorerOtherPrivileges : WindowBase
    {
        ...
        private async void btnGlobalOptionSets_Click(object sender, RoutedEventArgs e)
        {
            ...
            WindowHelper.OpenGlobalOptionSetsExplorer(this._iWriteToOutput, service, _commonConfig);
        }
        ...
        private async void btnMessageFilterTree_Click(object sender, RoutedEventArgs e)
        {
            ...
            WindowHelper.OpenSdkMessageFilterTree(this._iWriteToOutput, service, _commonConfig);
        }
