...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Properties {
    ...
    internal class MessageBoxStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Get WebResources Content {0} files on
        ///{1}?.
        /// </summary>
        internal static string GetWebResourcesContentFormat2 {
            get {
                return ResourceManager.GetString("GetWebResourcesContentFormat2", resourceCulture);
            }
        }
