...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Repository
{
    public class TeamRepository
    {
        ...
        private IEnumerable<Team> GetAvailableTeamsForRole(string filterTeam, Guid idRole, ColumnSet columnSet)
        {
            ...
            {
                var teams = GetTeamsByRole(idRole, null, ColumnSetInstances.None);
        ...
        private List<Guid> GetUserTeams(Guid idUser, Guid[] teamArray)
        {
            ...
            var result = new List<Guid>(_service.RetrieveMultipleAll<Team>(query).Select(e => e.Id));
        ...
        private List<Guid> GetTeamUsers(Guid idTeam, Guid[] userArray)
        {
            ...
            var result = new List<Guid>(_service.RetrieveMultipleAll<SystemUser>(query).Select(e => e.Id));
