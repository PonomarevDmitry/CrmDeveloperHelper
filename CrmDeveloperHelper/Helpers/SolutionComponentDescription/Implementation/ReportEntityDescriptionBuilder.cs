...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Helpers.SolutionComponentDescription.Implementation
{
    public class ReportEntityDescriptionBuilder : DefaultSolutionComponentDescriptionBuilder
    {
        ...
        public override string EntityPrimaryIdAttribute => ReportEntity.EntityPrimaryIdAttribute;
        ...
        public override IEnumerable<SolutionComponent> GetLinkedComponents(SolutionComponent solutionComponent)
        {
            ...
            var entity = GetEntity<ReportEntity>(solutionComponent.ObjectId.Value);
