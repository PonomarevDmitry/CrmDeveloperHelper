...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Helpers.SolutionComponentDescription.Implementation
{
    public class PrivilegeObjectTypeCodeDescriptionBuilder : DefaultSolutionComponentDescriptionBuilder
    {
        ...
        public override string EntityPrimaryIdAttribute => PrivilegeObjectTypeCodes.Schema.EntityPrimaryIdAttribute;

        protected override ColumnSet GetColumnSet()
        {
            return new ColumnSet(PrivilegeObjectTypeCodes.Schema.Attributes.privilegeobjecttypecodeid
