...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Helpers.SolutionComponentDescription.Implementation
{
    public class AttributeMapDescriptionBuilder : DefaultSolutionComponentDescriptionBuilder
    {
        ...
        public override string EntityPrimaryIdAttribute => AttributeMap.EntityPrimaryIdAttribute;
        ...
        public override IEnumerable<SolutionComponent> GetLinkedComponents(SolutionComponent solutionComponent)
        {
            ...
            var entity = GetEntity<AttributeMap>(solutionComponent.ObjectId.Value);

            if (entity != null)
            {
                if (entity.EntityMapId != null)
                {
                    result.Add(new SolutionComponent()
                    {
                        ObjectId = entity.EntityMapId.Id,
                        ComponentType = new OptionSetValue((int)ComponentType.EntityMap),
                    });
                }
            }
