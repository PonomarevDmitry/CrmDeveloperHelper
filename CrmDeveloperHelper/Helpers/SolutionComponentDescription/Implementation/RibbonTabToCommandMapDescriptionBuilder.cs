...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Helpers.SolutionComponentDescription.Implementation
{
    public class RibbonTabToCommandMapDescriptionBuilder : DefaultSolutionComponentDescriptionBuilder
    {
        ...
        public override string EntityPrimaryIdAttribute => RibbonTabToCommandMap.EntityPrimaryIdAttribute;
        ...
        public override IEnumerable<SolutionComponent> GetLinkedComponents(SolutionComponent solutionComponent)
        {
            ...
            if (entity != null)
            {
                if (!string.IsNullOrEmpty(entity.Entity)
                    ...
                    && _service.ConnectionData.IntellisenseData.Entities.ContainsKey(entity.Entity)
                )
                {
                    result.Add(new SolutionComponent()
                    {
                        ObjectId = _service.ConnectionData.IntellisenseData.Entities[entity.Entity].MetadataId,
