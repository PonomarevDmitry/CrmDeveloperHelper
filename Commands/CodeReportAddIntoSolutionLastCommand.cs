...
{
    internal sealed class CodeReportAddIntoSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeReportAddIntoSolutionLastCommandId;

        private CodeReportAddIntoSolutionLastCommand(Package package)
        {
        ...
        public static CodeReportAddIntoSolutionLastCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new CodeReportAddIntoSolutionLastCommand(package);
        }
        ...
        private void menuItem_BeforeQueryStatus(object sender, EventArgs e)
        {
            try
            {
                if (sender is OleMenuCommand menuCommand)
                {
                    ...
                    var visible = CommonHandlers.CheckActiveDocumentExtension(applicationObject, FileOperations.SupportsReportType);
