...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Commands
{
    internal sealed class FolderWebResourceCompareWithDetailsCommand : AbstractCommand
    {
        ...
        private static void ActionExecute(DTEHelper helper)
        {
            ...
            helper.HandleFileCompareCommand(selectedFiles, true);
        }
        ...
        private static void ActionBeforeQueryStatus(IServiceProviderOwner command, OleMenuCommand menuCommand)
        {
            ...
            CommonHandlers.CorrectCommandNameForConnectionName(command, menuCommand, "Compare files with details (Recursive)");
        }
    }
}
