...
{
    internal sealed class CodeWebResourceCompareInConnectionGroupCommand : IServiceProviderOwner
    {
        ...
        private CodeWebResourceCompareInConnectionGroupCommand(Package package, int baseIdStart, bool withDetails)
        {
        ...
        public static CodeWebResourceCompareInConnectionGroupCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new CodeWebResourceCompareInConnectionGroupCommand(package, PackageIds.CodeWebResourceCompareWithDetailsInConnectionGroupCommandId, true);
        }
