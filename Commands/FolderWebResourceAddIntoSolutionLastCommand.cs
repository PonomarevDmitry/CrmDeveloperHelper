...
{
    internal sealed class FolderWebResourceAddIntoSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FolderWebResourceAddIntoSolutionLastCommandId;

        private FolderWebResourceAddIntoSolutionLastCommand(Package package)
        {
        ...
        public static FolderWebResourceAddIntoSolutionLastCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new FolderWebResourceAddIntoSolutionLastCommand(package);
        }
        ...
        private void menuItem_BeforeQueryStatus(object sender, EventArgs e)
        {
            try
            {
                if (sender is OleMenuCommand menuCommand)
                {
                    ...
                    var visible = CommonHandlers.CheckInSolutionExplorerRecursive(applicationObject, FileOperations.SupportsWebResourceType);
