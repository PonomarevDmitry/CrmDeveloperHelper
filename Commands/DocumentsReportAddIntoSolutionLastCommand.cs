...
{
    internal sealed class DocumentsReportAddIntoSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsReportAddIntoSolutionLastCommandId;

        private DocumentsReportAddIntoSolutionLastCommand(Package package)
        {
        ...
        public static DocumentsReportAddIntoSolutionLastCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new DocumentsReportAddIntoSolutionLastCommand(package);
        }
        ...
        private void menuItem_BeforeQueryStatus(object sender, EventArgs e)
        {
            try
            {
                if (sender is OleMenuCommand menuCommand)
                {
                    ...
                    var visible = CommonHandlers.CheckOpenedDocumentsExtension(applicationObject, FileOperations.SupportsReportType);
