...
{
    internal sealed class FileWebResourceAddIntoSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.FileWebResourceAddIntoSolutionLastCommandId;

        private FileWebResourceAddIntoSolutionLastCommand(Package package)
        {
        ...
        public static FileWebResourceAddIntoSolutionLastCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new FileWebResourceAddIntoSolutionLastCommand(package);
        }
        ...
        private void menuItem_BeforeQueryStatus(object sender, EventArgs e)
        {
            try
            {
                if (sender is OleMenuCommand menuCommand)
                {
                    ...
                    var visible = CommonHandlers.CheckInSolutionExplorerAny(applicationObject, FileOperations.SupportsWebResourceType);
