...
{
    internal sealed class CodeWebResourceAddIntoSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.CodeWebResourceAddIntoSolutionLastCommandId;

        private CodeWebResourceAddIntoSolutionLastCommand(Package package)
        {
        ...
        public static CodeWebResourceAddIntoSolutionLastCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new CodeWebResourceAddIntoSolutionLastCommand(package);
        }
