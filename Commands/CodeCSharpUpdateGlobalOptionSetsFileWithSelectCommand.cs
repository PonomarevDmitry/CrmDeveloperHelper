...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Commands
{
    internal sealed class CodeCSharpUpdateGlobalOptionSetsFileWithSelectCommand : AbstractCommand
    {
        private CodeCSharpUpdateGlobalOptionSetsFileWithSelectCommand(Package package)
           : base(package, PackageGuids.guidCommandSet, PackageIds.CodeCSharpUpdateGlobalOptionSetsFileWithSelectCommandId, ActionExecute, CommonHandlers.ActionBeforeQueryStatusActiveDocumentCSharp) { }
