...
{
    internal sealed class DocumentsCSharpProjectPluginAssemblyStepsAddIntoSolutionLastCommand : IServiceProviderOwner
    {
        private readonly Package _package;

        public IServiceProvider ServiceProvider => this._package;

        private const int _baseIdStart = PackageIds.DocumentsCSharpProjectPluginAssemblyStepsAddIntoSolutionLastCommandId;

        private DocumentsCSharpProjectPluginAssemblyStepsAddIntoSolutionLastCommand(Package package)
        {
        ...
        public static DocumentsCSharpProjectPluginAssemblyStepsAddIntoSolutionLastCommand Instance { get; private set; }

        public static void Initialize(Package package)
        {
            Instance = new DocumentsCSharpProjectPluginAssemblyStepsAddIntoSolutionLastCommand(package);
        }
