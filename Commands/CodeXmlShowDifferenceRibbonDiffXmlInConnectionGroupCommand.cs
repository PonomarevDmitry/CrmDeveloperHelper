            ...
            try
            {
                if (sender is OleMenuCommand menuCommand)
                {
                    ...
                    if (0 <= index && index < list.Count)
                    {
                        ...
                        CommonHandlers.ActionBeforeQueryStatusActiveDocumentIsXmlWithRootWithAttribute(this, menuCommand, "RibbonDiffXml", Intellisense.Model.RibbonIntellisenseData.IntellisenseContextAttributeEntityName, out var attribute);
