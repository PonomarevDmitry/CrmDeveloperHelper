...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Views
{
    public partial class WindowExportGlobalOptionSets : WindowBase
    {
        ...
        private async Task CreateCSharpFile(IEnumerable<OptionSetMetadata> optionSets)
        {
            ...
            this._iWriteToOutput.WriteToOutput("Start creating file with OptionSets at {0}", DateTime.Now.ToString("dd.MM.yyyy HH:mm:ss"));
            ...
            this._iWriteToOutput.WriteToOutput("End creating file with OptionSets at {0}", DateTime.Now.ToString("dd.MM.yyyy HH:mm:ss"));
