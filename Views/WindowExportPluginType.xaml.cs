...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Views
{
    public partial class WindowExportPluginType : WindowBase
    {
        ...
        private async void ShowExistingPluginTypes()
        {
            if (!_controlsEnabled)
            {
                return;
        ...
        private async void ExecuteAction(Guid idPluginType, string name, Func<string, Guid, string, Task> action)
        {
        ...
        private void ContextMenu_Opened(object sender, RoutedEventArgs e)
        {
            ...
            {
                var items = contextMenu.Items.OfType<MenuItem>(); ConnectionData connectionData = null;
