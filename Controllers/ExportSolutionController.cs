...
namespace Nav.Common.VSPackages.CrmDeveloperHelper.Controllers
{
    public class ExportSolutionController
    {
        ...
        {
            this._iWriteToOutput.WriteToOutput("*********** Start Exporting CRM Solution at {0} *******************************************************", DateTime.Now.ToString("dd.MM.yyyy HH:mm:ss"));
            ...
            {
                this._iWriteToOutput.WriteToOutput("*********** End Exporting CRM Solution at {0} *******************************************************", DateTime.Now.ToString("dd.MM.yyyy HH:mm:ss"));
            }
        }
